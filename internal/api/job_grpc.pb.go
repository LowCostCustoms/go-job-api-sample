...
type JobServiceClient interface {
	ListJobs(ctx context.Context, in *ListJobsRequest, opts ...grpc.CallOption) (*JobPageReply, error)
	GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (*JobReply, error)
...
func (c *jobServiceClient) ListJobs(ctx context.Context, in *ListJobsRequest, opts ...grpc.CallOption) (*JobPageReply, error) {
	out := new(JobPageReply)
...
func (c *jobServiceClient) GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (*JobReply, error) {
	out := new(JobReply)
...
func (c *jobServiceClient) CreateJob(ctx context.Context, in *JobRequest, opts ...grpc.CallOption) (*JobReply, error) {
	out := new(JobReply)
...
type JobServiceServer interface {
	ListJobs(context.Context, *ListJobsRequest) (*JobPageReply, error)
	GetJob(context.Context, *GetJobRequest) (*JobReply, error)
...
func (UnimplementedJobServiceServer) ListJobs(context.Context, *ListJobsRequest) (*JobPageReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListJobs not implemented")
}
func (UnimplementedJobServiceServer) GetJob(context.Context, *GetJobRequest) (*JobReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetJob not implemented")
}
func (UnimplementedJobServiceServer) CreateJob(context.Context, *JobRequest) (*JobReply, error) {
